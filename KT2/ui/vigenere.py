...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(350, 50, 131, 21))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(130, 200, 47, 13))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(130, 250, 61, 21))
        self.label_4.setObjectName("label_4")
        self.txt_plain = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_plain.setGeometry(QtCore.QRect(250, 100, 441, 81))
        self.txt_plain.setObjectName("txt_plain")
        self.txt_key = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(250, 200, 441, 31))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher.setGeometry(QtCore.QRect(250, 250, 441, 71))
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(620, 360, 75, 23))
